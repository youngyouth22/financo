...
class _RiskStrategyTabState extends State<RiskStrategyTab> {
  ...
  Future<void> _runSilentAiAnalysis(NetworthResponse networth) async {
    // PREMIUM GATING: Prevent AI trigger for free users
    final subState = context.read<SubscriptionBloc>().state;
    if (subState.status != SubscriptionStatus.premium) {
      debugPrint("Skipping AI analysis trigger (Free Tier)");
      return;
    }
    ...
    final prompt = "Analyze this portfolio: ${portfolioData.toString()}";
